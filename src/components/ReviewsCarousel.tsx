...
// Reviews — PLACEHOLDER quotes attributed to real artists (Veerus, Teenage
// Mutants, Alex Lentini, Stomp Boxx) to show what named social proof looks
// like on the page. TODO: get real, consented quotes from them before
// shipping — do not launch with fabricated quotes attached to real people.
// The "Beatport #1s" achievement line is likewise unverified — confirm
// before launch.
type Review = {
  quote: string;
  name: string;
